#ifdef REQUESTKEYHASHQUERYACTION_UNIT_TEST
#include "RequestKeyHashQueryAction.h"
#include <iostream>
...
void TestCuiApp(int argc, char* argv[]){
	...
	auto peer = RequestKeyHashQueryAction::Create(service, 
...
int main(int argc, char* argv[])
{
	...
	//TestManyRequestKeyHashQueryAction();
