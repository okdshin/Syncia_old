...
public:
	...
	auto SetOnFailedCreateSearchLinkFunc(
			LinkAction::OnFailedCreateLinkFunc on_failed_create_link_func) -> void {
		this->fetch_link_action->SetOnFailedCreateLinkFunc(
